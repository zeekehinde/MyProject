...
const Homepage = () => {
    ...
    <div className='homepage-container'>
      <div className='section-one'>
        <div className='hero-image'>
          <img src={process.env.PUBLIC_URL + '/Assets/Group.png'} height='550px' width= '550' alt="" />
        </div>
      </div>
      ...
      <div className='Section-two' id='Section-two'>
        ...
        <div className='right'>
        <img src={process.env.PUBLIC_URL + '/Assets/African.png'} className='img1' height='400px' width= '400' alt='' />
        </div>
      </div>
      <div className='section-three'>
          ...
          <div className="imgs">
            <div className="order">
            <img src={process.env.PUBLIC_URL + '/Assets/ShoppingBasket.png'} className='img1' height='90px' width= '90' alt='' />
            <h3 className='sec3-text'>Order</h3>
            </div>
            <div className="payment">
            <img src={process.env.PUBLIC_URL + '/Assets/payment.png'} className='img1' height='90px' width= '90' alt='' />
            <h3 className='sec3-text'>Payment</h3>
            </div>
            <div className="delivery">
            <img src={process.env.PUBLIC_URL + '/Assets/delivery-truck.png'} className='img1' height='90px' width= '90' alt='' />
  ...
  <div className="container">
    <img src={process.env.PUBLIC_URL + '/Assets/Food.jfif'} className='Images' height='90px' width='90' alt='' />
    <h3 className='sec3-text'>Mama's Cooking Restaurant</h3>
    <p>We've got your breakfast, lunch <br /> and dinner covered</p>
    <div className="stars">
      <img src={process.env.PUBLIC_URL + '/Assets/11.png'} className='Images' height='10px' width='10px' alt='' />
      <img src={process.env.PUBLIC_URL + '/Assets/11.png'} className='Images' height='10px' width='10px' alt='' />
      <img src={process.env.PUBLIC_URL + '/Assets/11.png'} className='Images' height='10px' width='10px' alt='' />
      <img src={process.env.PUBLIC_URL + '/Assets/11.png'} className='Images' height='10px' width='10px' alt='' />
      <img src={process.env.PUBLIC_URL + '/Assets/22.png'} className='Images' height='10px' width='10px' alt='' />
    </div>
